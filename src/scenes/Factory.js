class Factory extends Phaser.Scene{
    ...
    create(){
        ...
        this.door = this.add.rectangle(2100, 400, 200, 300);
    ...
    update(){
        ...
        this.npc2.anims.play('greigidle', true);
        if(Frank == 1){
    ...
    createAnimation(){
        ...
        this.anims.create({
            key: 'greigidle',
            frames: this.anims.generateFrameNumbers('greig_idle', {start: 0, end: 3, first: 0}),
            frameRate: 4,
            repeat: -1
        });
    }
